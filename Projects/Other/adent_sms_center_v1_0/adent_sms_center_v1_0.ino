...
void loop() {
  ...
  while(Serial.available()) {
    ...
    if(a == 'E' && started == 1){ // end of the command.
      ...
      telephone1 = atoi(telephoneArray1);
      telephone2 = atoi(telephoneArray2);
      telephone3 = atoi(telephoneArray3);
      year = atoi(yearArray);
      month = atoi(monthArray);
      day = atoi(dayArray);
      hour = atoi(hourArray);
      minute = atoi(minuteArray);
      telephone.concat(telephone1);
      telephone.concat(telephone2);
      telephone.concat(telephone3);
      if(caseMsg == 1) {
